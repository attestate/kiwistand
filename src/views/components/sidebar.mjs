...
const newsletter = html`<svg
  style="width: 1.8rem; padding-top: 5px;"
  class="icon-svg"
  viewBox="0 0 24 24"
  fill="none"
  xmlns="http://www.w3.org/2000/svg"
...
const settings = html`
<svg
  style="width: 1.6rem; height: 1.6rem; padding-left: 6px;"
  viewBox="0 0 100 100"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
>
...
<svg 
  style="width: 1.6rem; height: 1.6rem; padding-left: 6.5px;" 
  viewBox="0 0 100 100" 
  version="1.1" 
  xmlns="http://www.w3.org/2000/svg">
 <g>
  <path d="m39.641 25.848c-1.9805-1.1094-3.8203-2.4648-5.4648-4.0234-3.3203-3.1484-5.9609-7.1758-7.8477-11.969l-2.7461-6.9805-2.7461 6.9805c-1.8867 4.793-4.5273 8.8203-7.8477 11.969-1.6523 1.5664-3.4883 2.9219-5.4609 4.0273l-4.5898 2.5742 4.5898 2.5742c1.9727 1.1055 3.8086 2.4609 5.4609 4.0273 3.3203 3.1445 5.9609 7.1719 7.8477 11.969l2.7461 6.9805 2.7461-6.9805c1.8867-4.793 4.5273-8.8203 7.8477-11.969 1.6523-1.5664 3.4883-2.9219 5.4648-4.0273l4.5938-2.5781z"/>
  <path d="m87.875 56.414c-2.0156-1.1289-3.8828-2.5039-5.5508-4.0859-3.4062-3.2305-6.1289-7.3867-8.082-12.355l-5.4961-13.961-5.4961 13.961c-1.957 4.9688-4.6758 9.125-8.082 12.355-1.6758 1.5898-3.543 2.9648-5.5469 4.0898l-9.1797 5.1523 9.1797 5.1484c2.0039 1.125 3.8711 2.5 5.543 4.0898 3.4102 3.2305 6.1289 7.3906 8.082 12.355l5.4961 13.961 5.4961-13.961c1.957-4.9688 4.6758-9.125 8.082-12.355 1.6758-1.5898 3.543-2.9688 5.5508-4.0898l9.1836-5.1523z"/>
 </g>
</svg>`;
...
const sidebar = html`
  ...
  >
    <div style="display: flex; align-items: center;">
      <div class="svg-container">${settings}</div>
      Settings
    </div>
  </a>
    <a
    ...
    <a
      href="https://t.me/kiwiupdates"
      style="color: black; text-decoration: none; display: block;"
    >
      <div style="display: flex; align-items: center;">
        <div class="svg-container">${productUpdates}</div>
        Product Updates
      </div>
    </a>
    <hr
