                ...
                <td>
                  <div style="padding: 20px;">
                    ...
                    <p>
                      ...
                      leading forum for intellectual exchange - has become
                      openly hostile towards crypto. Creators are thus relegated
                      to sharing their content through Discord, Telegram, and
                      various social media channels, praying that by a stroke of
                      luck, someone will notice their work.
                    </p>
                    <p>
                    ...
                    <p>
                      That's why we created Kiwi News - to help both creators
                      and readers.
                    </p>
                    <p>
                      For creators we provide a platform that levels the playing
                      field and helps them to be heard. Even when their content
                      is not shared by the most popular kids in the room. Kiwi
