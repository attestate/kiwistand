...
const CONTEST_START_DATE = new Date('2025-08-25T12:00:00Z'); // Aug 25 12pm noon CEST (UTC+2)
const CONTEST_END_DATE = new Date('2025-08-29T17:00:00Z'); // Aug 29 5pm CEST (UTC+2)
const PRIZE_POOL = 50; // 50 USDC
